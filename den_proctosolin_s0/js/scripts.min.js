...
$(function() {
    ...
    $(".section8 .main-text-btn").hover(function() {
        ...
        $(".people-review").val().length > 0 ? ($(".popup-container").show(), $(".popup-container").mouseup(function(t) {
            var e = $(".popup-container");
            0 === e.has(t.target).length && (e.hide(), $(".people-review").val(""))
        })) : $(".popup-container").hide()
    }), $(".close_popup").click(function() {
        $(".popup-container").hide(), $(".people-review").val("")
    });
});
(function(h, o, g) {
    var p = function() {
